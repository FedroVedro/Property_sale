...
import { Form, Button, Card, Input, Typography, message, Radio } from "antd";
...
const RegisterPage = (): JSX.Element => {
  ...
  const handleRegisterUser = (values: any) => {
    dispatch(registerUser(values.login, values.password, values.role));
      ...
      <div className={styles.content}>
        ...
        >
          ...
          >
            ...
            <Form.Item name="role" label="Кто я?">
              <Radio.Group
                optionType="button"
                buttonStyle="solid"
                defaultValue="3"
              >
                <Radio value="3">Покупатель</Radio>
                <Radio value="2">Продавец</Radio>
              </Radio.Group>
            </Form.Item>
